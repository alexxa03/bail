...
<p align="center">
  <img src="https://files.catbox.moe/oets7u.jpg" alt="Thumbnail" />
</p>
...
```json
"depencies": {
  "@whiskeysockets/baileys": "github:alexxa03/bail"
}
```
## Import
```javascript
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    url: "https://t.me/alexxa03",
    body: "Nak Tido",
    footer: "Footer",
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"alecaesar\",\"url\":\"https://t.me/alecaesarr\"}"
      }
    ],
